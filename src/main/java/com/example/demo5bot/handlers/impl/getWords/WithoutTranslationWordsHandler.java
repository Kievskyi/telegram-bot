...
@Component
public class WithoutTranslationWordsHandler extends UserRequestHandler {

    private static final String command = "Без перекладу";
    private final SendMessageService messageService;
    private final UserRepository repository;
    private final KeyboardMarkup keyboardMarkup;

    public WithoutTranslationWordsHandler(SendMessageService messageService, UserRepositoryMySqlImpl repository, KeyboardMarkup keyboardMarkup) {
    ...
    public void handle(UserRequest userRequest) {
        ...
        String words = repository.getAllWords(userId, MessageStatus.GET_ALL_WORDS_WITHOUT_TRANSLATION);
